...
<html>
	...
	<body>
		<form action="qyerybgto" method="post">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="11%" class="TD_STYLE2">
						<input type="text" name="sname" id="standardName" value="${sa.sname}"
							class="INPUT_STYLE2">
					</td>
					...
					<td width="17%" class="TD_STYLE2">
						<input type="text" name="ssum" id="sumSalary" value="${sa.ssum}"
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="sdesigner" id="designer" value="${userlogin.user_true_name}"
							class="INPUT_STYLE2">
					</td>
					<td class="TD_STYLE1">
						变更人
					...
					<td class="TD_STYLE2">
						<input type="text" name="schanger" value="${userlogin.user_true_name}"
				...
				<c:forEach items="${saslist}" var="sa" varStatus="vs">
				<tr class="TD_STYLE2">
					<td align="center">${vs.count }</td>
					<td colspan="3">${sa.name}</td>
					<td>
					<input type="text" id="salary${vs.count}" value="${sa.money}" name="csum" 
						onkeyup="countMoney('6','salary${vs.count}')" class="INPUT_STYLE2">
					<input type="hidden" name="pbcid" value="${sa.xcxmid }">
					</td>
					<td colspan="3">
						&nbsp;
					</td>

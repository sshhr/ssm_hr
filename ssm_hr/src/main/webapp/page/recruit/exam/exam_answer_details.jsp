...
<html>
	...
	<body>
		<form name="salary" method="post" id="myform" action="examResultSift?resId=${answerInfo.resumeId}">
			...
			<table width="100%">	
				...
				<tr>
				    <td align="right">
					 考试用时: <input type="text" id="time" name="engageAnswer.useTime" value="${answerInfo.useTime}" readonly="readonly" >
					</td>
				</tr>
				<tr>
					<td align="right">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="100" class="TD_STYLE2">
						<input type="text" name="engageAnswer.examNumber" value="${answerInfo.examNumber}" readonly="readonly"  class="INPUT_STYLE2">
					</td>
					<td width="74" class="TD_STYLE1">
						试题数量
					</td>
					<td width="100" class="TD_STYLE2">
						<input type="text" name="questionAmount" value="${size}" readonly="readonly" class="INPUT_STYLE2">
					</td>
				...
				<tr>
					...
					<td width="100" class="TD_STYLE2">
						<input type="text" name="engageAnswer.humanName" value="${answerInfo.humanName}" readonly="readonly"  class="INPUT_STYLE2">
					</td>
					<td width="74" class="TD_STYLE1">
						身份证
					</td>
					<td width="100" class="TD_STYLE2">
						<input type="text" name="engageAnswer.humanIdcard" value="${answerInfo.humanIdcard }" readonly="readonly" class="INPUT_STYLE2">
					</td>
				</tr>
			</table>
			<p style="color:green">
				最后得分：${answerInfo.totalPoint}
			</p>
			<!-- 展示题目都是单选 -->
			<c:forEach items="${resultlist }" var="i"  varStatus="j">
			<div>

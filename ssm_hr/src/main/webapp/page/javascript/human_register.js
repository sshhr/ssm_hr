$(function() {
	...
	$("#birthday").click(function() {
		displayDatePicker('humanbirthday', false, 'ymd', '')
	});
	$("#firstKind").change(function() {
		$.ajax({
			...
			data : "configFilesecondKind.firstKind=" + $(this).val(),
	...
	$("#secondKind").change(function() {
		$.ajax({
			...
			data : "configFileThirdKind.firstKind=" + $("#firstKind").val() + "&configFileThirdKind.secondKind=" + $(this).val(),
			success : function(data) {

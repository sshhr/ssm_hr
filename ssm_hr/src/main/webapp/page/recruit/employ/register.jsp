...
<head>
	...
	<body onload="check(),ly()">
		<form action="/ssm_hr/employ/registerOk.do" name="fm" method="post"  enctype="multipart/form-data">
		...
		<input type="hidden" name="resId" value="${vi.resId }"/>
			<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="radio"  name="result" value="释放简历" onclick="sf()">释放简历
						<input type="radio"  name="result" value="申请录用" checked="checked" onclick="ly()">申请录用
			...
			<tr>
				...
				<tr>
					...
					<td class="TD_STYLE2"> 
				  	<input type="text" name="passchecktime"

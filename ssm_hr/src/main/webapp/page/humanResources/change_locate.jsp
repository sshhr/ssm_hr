...
<html>
	...
	<body>
		<form method="post" action="/ssm_hr/humanresources/changeList.do">
		...
		<input  name="majorId" type="hidden" id="majorId">
			<table width="100%">
				...
				<tr>
					<td align="right">
						...
						<input type="button" value="搜索" class="BUTTON_STYLE1" onclick=" window.location.href='/ssm_hr/humanresources/changeSearchPage.do'">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="84%" class="TD_STYLE2">
						<input type="text" name="min" onclick="aa('startdate')" readonly="readonly"
							style="width: 14%" class="INPUT_STYLE2" id="date_start">
						至
						<input type="text" name="max" onclick="aa('enddate')" readonly="readonly"
